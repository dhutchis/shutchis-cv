...
%big data analytics
\cvitem{Objective}{To bridge linear and relational algebra systems both in theory and in practice.\\
\phantom{\textbf{Objective}: }To build the \emph{polystore optimizer} that translates and optimizes queries across\\
\phantom{\textbf{Objective}: }systems, taking all known statistics, properties, and equivalences into account.
% To enable a new class of declarative programming, whose execution accounts for all available systems, hardware, and known performance statistics.
...
\section{Activities}
{\small
\cvitem{Global Grand Challenges Summit}{\textit{2017}, authored a podcast with Sarah Engel on \emph{The ``Power'' of the Internet}\\
...
\cvitem{Reviewer for \href{http://onlinelibrary.wiley.com/journal/10.1111/(ISSN)1365-2575}{Information Systems}}{\textit{2016--2017}, a journal published by Wiley}
\cvitem{Myria Database Maintainer}{Maintain the \href{http://myria.cs.washington.edu/}{Myria database} alongside \href{http://db.cs.washington.edu/}{UWDB students}}
