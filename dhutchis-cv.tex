...
\email{dhutchis@cs.washington.edu}                               % optional, remove / comment the line if not wanted
%\homepage{www.cs.stevens.edu/\textasciitilde dhutchis}
\homepage{linkedin.com/in/dylanhutchison}
\extrainfo{\href{http://github.com/dhutchis}{github.com/dhutchis}}                 % optional, remove / comment the line if not wanted
