...
% \parsep0pt
% \itemsep0pt
\listitemsymbol Contributing code and discussion to the Apache Accumulo NoSQL database community
% \end{itemize}
}
...
\begin{itemize}%
\item Develop sum-product, fusion, and other optimizations for \href{https://systemml.apache.org/}{Apache SystemML}.
\end{itemize}}
