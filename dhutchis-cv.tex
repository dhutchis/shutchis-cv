...
%\vspace{-0.8em}
\section{Education}
\cventry{9/2015-- $\approx$2019}{}{\href{https://www.cs.washington.edu/}{University of Washington}% -- \textnormal{\emph{PhD in Computer Science \& Engineering}}
}{Seattle, WA}{}{
\vspace{\upcventry}
...
\begin{itemize}%
\item Develop cost-based optimization for \href{https://systemml.apache.org/}{Apache SystemML} based on elementary rewrites over sum-product operators
\item Achieve speedups as large as 20,000x on machine learning algorithm kernels
\end{itemize}}
